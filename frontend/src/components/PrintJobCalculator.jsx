      ...
      {results && (
        <Card>
          ...
          <CardContent>
            ...
            {/* Extras Results */}
            {results.extrasResults && (
              <div className="mt-6">
                {results.job.isBookletMode ? (
                  // Booklet Mode: Separate Cover and Inner Extras
                  <div className="space-y-4">
                    {results.extrasResults.coverExtras && results.extrasResults.coverExtras.length > 0 && (
                      <div className="p-4 border rounded-lg bg-green-50">
                        <h3 className="text-lg font-semibold text-green-800 mb-4 flex items-center gap-2">
                          <Award size={18} />
                          Cover Extras & Finishing Costs
                        </h3>
                        ...
                        <div className="space-y-3">
                            ...
                            <div key={index} className="p-3 border rounded-lg bg-white">
                              <div className="flex justify-between items-start">
                                      ...
                                      {extra.pricingType === 'per_length' && (
                                        <>
                                          ...
                                          <span className="text-xs text-blue-600">
                                            Using bound edge ({results.job.bindingEdge} edge)
                                          </span>
                                        </>
                                      )}
                                    </p>
                                ...
                                <div className="text-right">
                                  <p className="font-bold text-green-600">${extra.totalCost.toFixed(2)}</p>
                                </div>
                              </div>
                            </div>
                          ))}
                          ...
                          <div className="border-t pt-3 mt-4">
                            <div className="flex justify-between items-center">
                              <span className="font-bold text-lg text-gray-800">Cover Extras Total:</span>
                    ...
                    {results.extrasResults.innerExtras && results.extrasResults.innerExtras.length > 0 && (
                      <div className="p-4 border rounded-lg bg-orange-50">
                        <h3 className="text-lg font-semibold text-orange-800 mb-4 flex items-center gap-2">
                          <Award size={18} />
                          Inner Pages Extras & Finishing Costs
                        </h3>
                        ...
                        <div className="space-y-3">
                          {results.extrasResults.innerExtras.map((extra, index) => (
                            <div key={index} className="p-3 border rounded-lg bg-white">
                              <div className="flex justify-between items-start">
                                ...
                                <div className="text-right">
                                  <p className="font-bold text-orange-600">${extra.totalCost.toFixed(2)}</p>
                                </div>
                              </div>
                            </div>
                          ))}
                          ...
                          <div className="border-t pt-3 mt-4">
                            <div className="flex justify-between items-center">
                              <span className="font-bold text-lg text-gray-800">Inner Pages Extras Total:</span>
                    ...
                    {/* Combined Total for Booklet Mode */}
                    {((results.extrasResults.coverExtras && results.extrasResults.coverExtras.length > 0) || 
                      (results.extrasResults.innerExtras && results.extrasResults.innerExtras.length > 0)) && (
                      <div className="p-4 border-2 rounded-lg bg-purple-50 border-purple-200">
                        <div className="flex justify-between items-center">
                          <span className="font-bold text-xl text-gray-800">Total Extras Cost:</span>
                  ...
                  // Normal Mode: Single Extras Section
                  results.extrasResults.length > 0 && (
                    <div className="p-4 border rounded-lg bg-purple-50">
